...
```{r, fig.cap= "Figure 2: Figure 2 displays the linear mixed effects model of the ln of Age of First Reproduction versus the ln of Offspring per year. The purple line is the general linear for all of the data points. The other 7 lines are the trends for the individal orders."}
